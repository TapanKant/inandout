...
public class CategoryViewFragment extends Fragment {
    ...
    class CategoryBookRecyclerAdapter extends RecyclerView.Adapter<CategoryBookRecyclerAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, final int arg1) {
            ...
            imageLoader.get ( dataSet.get(arg1).getImageURL (), ImageLoader.getImageListener ( holder.productImage, R.id.cart_item_layout_image, android.R.drawable.ic_dialog_alert ) );
            ...
            holder.addToCart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!KartBroadCastReceiver.isConnected ()){
                        Snackbar.make ( v.getRootView (), "No internet connection!!!", 300 ).show ();
                        return;
                    }
    ...
    class ProductImageListener implements  View.OnClickListener{
        ...
        public void onClick(View view) {
            if (!KartBroadCastReceiver.isConnected ()){
                Snackbar.make ( view.getRootView (), "No internet connection!!!", 300 ).show ();
                return;
            }
